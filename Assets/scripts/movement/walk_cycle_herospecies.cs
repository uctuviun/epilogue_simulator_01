...
public class walk_cycle_herospecies : MonoBehaviour {
	...
	//FINISH BLOOD: SET EXPLOSION TO HAPPEN DURING KILLMODE AND ACTIVATE KILLEDTOWN
	...
	void Update () {
		if(PlayerPrefs.GetInt("killMode") == 1){
